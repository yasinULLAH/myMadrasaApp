...
## 🆕 نئے شامل کردہ فیچرز (Recently Added Features)

### 📥 لاگ ان سے پہلے ڈیٹا مینجمنٹ (Pre‑Login Data Management)
| فیچر | تفصیل |
|------|-------|
| **گوگل ڈرائیو سے ڈیٹا حاصل کریں** | لاگ ان پیج پر ہی گوگل ڈرائیو سے بیک اپ ڈاؤن لوڈ کریں |
| **فائل سے ڈیٹا درآمد کریں** | ZIP فائل اپ لوڈ کر کے لاگ ان سے پہلے ڈیٹا بحال کریں |
| **لاگ ان سے پہلے مطابقت** | گوگل ڈرائیو سے تازہ ترین ڈیٹا لے کر لاگ ان کریں |

### 🧾 فوری رسید جنریٹر (Quick Receipt Generator)
بغیر طالب علم کے اکاؤنٹ کے کسی بھی شخص سے رقم وصول کرنے اور رسید دینے کے لیے۔
- نام، مد، رقم، تاریخ، رسید نمبر
- فوری پرنٹ

### 👥 فعال صارفین (Active Users)
سائیڈبار میں دکھتا ہے کہ اس وقت کتنے اور کون سے صارفین لاگ ان ہیں (ملٹی‑ٹیب سپورٹ)۔

### 🔄 سنک اسٹیٹس بار (Sync Status Bar)
سائیڈبار میں نیچے ڈیٹا سنک کی حالت دکھتی ہے، دستی مطابقت کے لیے کلک کریں۔

### 🏪 لائبریری میں کتابوں کا علیحدہ انتظام (Library Books Management)
- کتابوں کی علیحدہ کیٹلاگ (کتاب کا نام، مصنف، کل تعداد، دستیاب تعداد)
- اجراء/واپسی کا علیحدہ ریکارڈ
- انوینٹری سے خودکار اسٹاک اپ ڈیٹ

### 🛏️ ہاسٹل میں کمروں کا علیحدہ انتظام (Hostel Rooms Management)
- کمروں کی علیحدہ کیٹلاگ (کمرہ نمبر، گنجائش)
- کمرے میں گنجائش سے زیادہ طلبا نہیں ڈال سکتے
- رہائشی طلبا کا علیحدہ ریکارڈ

### 🏅 ڈونرز مینجمنٹ (Donors Management)
- ڈونرز کی علیحدہ کیٹلاگ (نام، رابطہ)
- ڈونر کے تمام عطیات کی ہسٹری

### 📚 تعلیمی سال اور آرکائیو (Academic Year & Archive)
- تعلیمی سال کا نظم
- سال ختم / ترقی دینے کا وزرڈ
- پروموشن اور آرکائیو کا مکمل ریکارڈ

### 🆔 مشترکہ دستاویزات پیج (Combined Documents Page)
- ایک ہی پیج پر: طالب علم ID Card، استاد ID Card، Leaving Certificate، Sanad، Character Certificate
